...
class ProjectService:
    ...
    def create_project(self, project_name: str, existing_projects: dict[str, str]) -> str:
        ...
        if existing_projects:
            max_id = max(int(pid) for pid in existing_projects)
        ...
        project_dir = (
            self.projects_dir / f"project-{project_id}-{safe_name.replace(' ', '-').lower()}"
        )
    ...
    def add_note(self, project_id: str, text: str, translation: str | None = None) -> bool:
